...
namespace Photon.MmoDemo.Server
{
    ...
    /// <summary>
    /// This message contains the current position AND rotation of the Item. 
    /// This type of message is published by items through the Item.PositionUpdateChannel. 
    /// </summary>
    public class ItemPositionRotationMessage
    {
        public ItemPositionRotationMessage(Item source, Vector position, Vector rotation)
        {
            this.Source = source;
            this.Position = position;
